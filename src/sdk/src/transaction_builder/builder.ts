...
import { DEFAULT_TXN_EXP_SEC_FROM_NOW, DEFAULT_MAX_GAS_AMOUNT } from "../utils";
 ...
 */
export class TransactionBuilderRemoteABIPayload {
  ...
  async buildTranSactionPayload(func: Gen.EntryFunctionId, ty_tags: Gen.MoveType[], args: any[]): Promise<TransactionPayload> {
    ...
    return builderABI.buildTransactionPayload(func, ty_tags, args);
  }
}
